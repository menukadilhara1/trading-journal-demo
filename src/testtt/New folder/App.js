...
const handleToggleBreakeven = (id) => {
 ...
 flex items-center justify-center p-4">
        <div className="text-2xl font-medium text-[#64748B] animate-pulse">
          Loading...
        </div>
      </div>
    );
      ...
      <div className="min-h-screen bg-[#FAFAFA] flex">
        <div className="bg-white rounded-3xl p-8 max-w-md w-full shadow-lg">
          <div className="flex items-center gap-3 mb-8">
            <div className="bg-[#2563EB] p-3 rounded-2xl">
              <BookOpen className="w-6 h-6 text-white" />
            </div>
            <h1 className="text-2xl font-bold text-[#171717]">Easy Trades</h1>
          </div>
         ...
         <input
            ...
            className="w-full px-4 py-3 rounded-xl border border-[#E2E8F0] focus:border-[#2563EB] focus:outline-none mb-3"
          />
        ...
        <input
            ...
            className="w-full px-4 py-3 rounded-xl border border-[#E2E8F0] focus:border-[#2563EB] focus:outline-none mb-4"
          />
            ...
            <button
              ...
              className={`w-full py-3 rounded-xl font-semibold transition-colors ${
                loginLoading
                  ? "bg-gray-300 text-[#64748B] cursor-not-allowed"
 ...
 flex  ">
  ...
  {activePage === "trades" && (
    <>
      ...
      <div className="pt-4 bg-white/60 rounded-xl p-6 border border-black/5 ">
        
           {/* CARDS BEHIND LAYER */}
        <div className="flex items-center justify-between mb-4">

        <h2 className="text-xl font-bold text-[#171717]">Recent Trades</h2>   
        <div 
        
        className="mb- flex justify-center" >
    ...
    <div className="fixed inset-0 z-[999] bg-black/50 flex items-center justify-center p-4">
      <div className="bg-white w-full max-w-md rounded-3xl border border-[#E2E8F0] shadow-xl">
        <div className="p-6 border-b border-[#E2E8F0] flex items-center justify-between">
          <div>
            <div className="text-lg font-bold text-[#171717]">Create account</div>
            <div className="text-xs text-[#64748B]">Required before adding trades</div>
          </div>
...
<div className="p-6 border-t border-[#E2E8F0] flex items-center gap-2">
  {/* Left: Delete */}
 <button
  type="button"
  onClick={onDelete}
  ...
  className={`py-3 px-4 rounded-xl font-semibold border transition
    ${
      isLastAccount
        ? 'bg-[#F8FAFC] text-gray-400 border-[#E2E8F0] cursor-not-allowed'
        : 'bg-white text-[#EF4444] border-red-200 hover:bg-[#FEF2F2] hover:border-red-300'
    }
  `}
>
  Delete
...
{isLastAccount && (
  ...
  <div className="flex gap-2">
    <button
      type="button"
      onClick={onClose}
      className="py-3 px-4 rounded-xl bg-[#F8FAFC] text-[#64748B] font-semibold hover:bg-gray-200"
    >
      Cancel
    </button>
    ...
    <button
      type="button"
      onClick={submit}
      className="py-3 px-6 rounded-xl bg-[#2563EB] text-white font-semibold hover:bg-[#2563EB]"
    >
      Save
    </button>
  </div>
...
const handleSave = () => {
  ...
  return (
    ...
    >
      <div
        className="bg-white w-full max-w-md rounded-3xl border border-[#E2E8F0] shadow-xl"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="p-6 border-b border-[#E2E8F0] flex items-center justify-between">
          <div>
            <div className="text-lg font-bold text-[#171717]">Starting balance</div>
            <div className="text-xs text-[#64748B]">Used to calculate your balance</div>
          </div>
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-end sm:items-center justify-center p-4">
      <div className="bg-white rounded-t-3xl sm:rounded-3xl max-w-2xl w-full p-6">
        <div className="flex items-center justify-between mb-5">
          <h2 className="text-xl font-bold text-[#171717]">Filters</h2>
          <button onClick={onClose} className="p-2 hover:bg-[#F8FAFC] rounded-full">
            <X className="w-5 h-5" />
          </button>
        </div>
  ...
  return (
    ...
    <div className="relative bg-white rounded-t-3xl sm:rounded-3xl max-w-2xl w-full max-h-[90vh] min-h-[60vh] overflow-hidden flex flex-col">
      ...
      <button
        type="button"
        onClick={onClose}
        className="absolute top-6 right-5 p-2 hover:bg-[#F8FAFC] rounded-full transition-colors"
        aria-label="Close"
      >
        <X className="w-6 h-6" />
        </button>
  ...
  return (
    <div className="fixed inset-0 z-[999] bg-black/50 flex items-center justify-center p-4">
      <div className="bg-white rounded-t-3xl sm:rounded-3xl max-w-2xl w-full h-[90vh] flex flex-col overflow-hidden">
        ...
        <div className="p-6 border-b border-[#E2E8F0] flex items-center justify-between">
          <div>
            <div className="text-lg font-bold text-[#171717]">Manage quick symbols</div>
            <div className="text-xs text-[#64748B]">Max {QUICK_SYMBOLS_MAX}</div>
          </div>
...
const inputClass = (key, value, extra = "") => {
  ...
  function QuickTagsManagerModal({
    ...
    return (
      <div className="fixed inset-0 z-[999] bg-black/50 flex items-center justify-center p-4">
        <div className="bg-white w-full max-w-lg rounded-3xl border border-[#E2E8F0] shadow-xl">
          <div className="p-6 border-b border-[#E2E8F0] flex items-center justify-between">
            <div>
              <div className="text-lg font-bold text-[#171717]">Manage quick tags</div>
              <div className="text-xs text-[#64748B]">Max {QUICK_TAGS_MAX}</div>
            </div>
          ...
          <div className="p-6 space-y-3">
                ...
                <div key={idx} className="flex items-center gap-2">
                  <input
                    ...
                    className={`flex-1 px-4 py-3 rounded-xl border focus:outline-none ${
                      dup ? 'border-red-300 focus:border-red-400' : 'border-[#E2E8F0] focus:border-blue-500'
                    }`}
                  />
                  ...
                  <button
                    ...
                    className="px-3 py-3 rounded-xl border border-[#E2E8F0] text-[#64748B] hover:text-[#EF4444] hover:border-red-200"
                    title="Remove"
                  >
                    ×
                  </button>
            ...
            {draft.length < QUICK_TAGS_MAX && (
              <button
                type="button"
                onClick={addOne}
                className="w-full py-3 rounded-xl border border-[#E2E8F0] text-[#64748B] hover:border-[#E2E8F0] hover:bg-[#FAFAFA]"
              >
                + Add tag
              </button>
            )}
  ...
  <div className="relative inline-flex rounded-2xl border border-[#E2E8F0] bg-white p-1 shadow-sm">
    ...
    <button
      ...
      className={`relative z-10 w-[110px] px-4 py-2 rounded-xl text-sm font-bold transition ${
        tradeFormMode === "basic" ? "text-white" : "text-[#64748B] hover:text-[#171717]"
      }`}
    >
      Basic
    </button>
    ...
    <button
      ...
      className={`relative z-10 w-[110px] px-4 py-2 rounded-xl text-sm font-bold transition ${
        tradeFormMode === "advanced" ? "text-white" : "text-[#64748B] hover:text-[#171717]"
      }`}
    >
      Advanced
    </button>
...
<button
  ...
  className={`w-full py-4 rounded-xl font-semibold text-lg transition-colors ${
    saving ? "bg-gray-300 text-[#64748B] cursor-not-allowed" : "bg-[#2563EB] text-white hover:bg-[#2563EB]"
  }`}
>
...
<div className="min-h-screen bg-[#FAFAFA] flex">
    <aside className={`min-h-screen bg-white  border-r border-[#E2E8F0]   overflow-hidden transition-all duration-300 ${
...
>
      ...
      <div className="">
        ...
        <div className={`p-6 border-b border-[#E2E8F0] flex items-center gap-3 ${sidebarOpen ? '' : 'justify-center'}`}>
          <div className="w-10 h-10 bg-[#2563EB] rounded-xl flex items-center justify-center">
            <BookOpen className="w-5 h-5 text-white" strokeWidth={2.5} />
          </div>
          {sidebarOpen && <h1 className="text-lg font-bold text-[#171717] tracking-tight">Eazy Trades</h1>}
      ...
      <nav className="flex-1 p-4">
        <div className="space-y-4">
          ...
          <button
              type="button"
              onClick={() => onNavigate("trades")}  className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg bg-[#EFF6FF] text-[#2563EB] font-semibold text-sm transition-colors
          ...
          <button
              type="button"
              onClick={() => onNavigate("analytics")}  className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg text-[#64748B] font-medium text-sm transition-colors
                ${sidebarOpen ? 'justify-start px-4' : 'justify-center px-0'}
          ...
          type="button"
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg text-[#64748B]  font-medium text-sm transition-colors
                ${sidebarOpen ? 'justify-start px-4' : 'justify-center px-0'}
                bg-white/60 shadow-sm border border-white/70`}
            >
...
>
  ...
  {sidebarOpen && <span className="font-medium tracking-tight">Journal</span>}
          ...
          <button   className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg text-[#64748B]  font-medium text-sm transition-colors
              ${sidebarOpen ? 'justify-start px-4' : 'justify-center px-0'}
              bg-white/60 shadow-sm border border-white/70`}
          >
...
>
        ...
        <button
          onClick={onLogout}
          className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-[#EF4444] hover:bg-[#FEF2F2] transition-all"
        >
...
const topBarBtn =
  ...
  "text-[#64748B] hover:text-[#64748B] transition-all";
  ...
  return (
    ...
    //topbar   min-h-screen bg-white  border-r border-[#E2E8F0]   overflow-hidden transition-all duration-300//
    
  <div className="min-w-screen bg-white  border-b border-[#E2E8F0] px-3  py-3 flex items-center justify-between"
  >
    {/* LEFT */}
    <div className="flex items-center gap-3">
      <button
        ...
        className="w-10 h-10 rounded-2xl bg-white/70 border border-white/70 shadow-sm
               flex items-center justify-center text-[#64748B] hover:bg-white transition"
      ...
      <h1 className="text-lg font-bold text-[#171717]">Dashboard</h1>
    </div>
    ...
    <div className="flex items-center gap-2">
    {backendSyncing && (
  <div className="px-3 py-1 rounded-full text-xs font-semibold border border-[#E2E8F0] bg-white text-[#64748B]">
    Syncing…
  </div>
)}
      ...
      <div className="relative">
        <button
          ...
          className={`
            px-4 py-2 rounded-xl text-sm font-medium flex items-center gap-2
            transition-all
            ${calOpen ? 'bg-white text-[#171717] shadow-sm' : 'text-[#64748B] hover:text-[#64748B]'}
          `}
          type="button"
        >
      ...
      <button
        ...
        className="px-4 py-2 rounded-xl text-sm font-medium flex items-center gap-2
               transition-all text-[#64748B] hover:text-[#64748B]"
        type="button"
      >
      ...
      <button
        ...
        className="px-4 py-2 rounded-xl text-sm font-semibold
               bg-white text-[#64748B] shadow-sm flex items-center gap-2"
        type="button"
      >
...
function CalendarPopover({ value, onChange, onClose }) {
  ...
  return (
    <div
  className="absolute right-0 mt-2 w-80 bg-white border border-[#E2E8F0] rounded-2xl shadow-lg p-4 z-50"
  onClick={(e) => e.stopPropagation()}
>
      ...
      <div className="flex items-center justify-between mb-3">
        <button
          ...
          className="p-2 hover:bg-[#F8FAFC] rounded-xl"
        >
          ‹
        </button>

        <div className="font-semibold text-[#171717]">{monthLabel}</div>
      ...
      <div className="grid grid-cols-7 text-xs text-[#64748B] mb-2">
      ...
      <div className="grid grid-cols-7 gap-1">
        {cells.map((d, idx) => {
          ...
          const cls = [
            ...
            inRange && !(selectedStart || selectedEnd) ? "bg-[#F8FAFC] text-[#171717]" : "",
            !(selectedStart || selectedEnd || inRange) ? "hover:bg-[#FAFAFA] text-[#171717]" : ""
          ].join(" ");
      ...
      <div className="flex gap-2 mt-4">
        <button
          ...
          className="flex-1 py-2 rounded-xl bg-[#F8FAFC] text-[#64748B] font-semibold hover:bg-gray-200"
        >
          Reset
        </button>
        <button
          onClick={onClose}
          className="flex-1 py-2 rounded-xl bg-[#2563EB] text-white font-semibold hover:bg-[#2563EB]"
        >
          Apply
        </button>
      </div>
...
//HERO CARDS//
 ...
 return (
 <div className="grid grid-cols-1  md:grid-cols-2 lg:grid-cols-4 pt-2 gap-6 px-6">
...
{/* Balance card */}
<div className="relative bg-white rounded-xl p-6 border border-black/5 transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 hover:border-[#2563EB]/40 flex flex-col">

  <div className="flex items-start justify-between">
    <p className="text-xs font-semibold text-[#64748B] uppercase tracking-wider mb-2">BALANCE</p>
    ...
    <div className="group relative">
      <button
        ...
        className={`leading-none ${
          canEdit ? "text-gray-400 hover:text-[#64748B]" : "text-gray-200 cursor-not-allowed"
        }`}
        type="button"
        aria-label="Edit account"
      >
        <Edit2 className="w-4 h-4 text-[#64748B]" strokeWidth={2} />
      </button>
  ...
  {stats.startingBalance == null ? (
    <p className="text-lg font-medium text-[#64748B] mt-2">Set balance</p>
  ) : (
    <>
      <p className="text-3xl font-bold text-[#171717] tracking-tight mb-1">
      ...
      {/* Total */}
  <div className="bg-white rounded-xl p-6 border border-black/5 transition-all duration-200 hover:shadow-md 
  hover:-translate-y-0.5 hover:border-[#2563EB]/40 flex flex-col">
        ...
        <p
  className={`text-3xl font-bold text-[#10B981] tracking-tight mb-1 ${
    stats.total > 0
      ? 'text-green-400'
      : stats.total < 0
        ? 'text-red-400'
...
>
  ...
  : `${stats.total > 0 ? '+' : ''}${stats.total}R`}
        ...
        <p className="text-xs text-[#64748B]">{stats.totalTrades} trades</p>
      </div>

      {/* Win rate */}

        <div className="bg-white rounded-xl p-6 border border-black/5 transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 hover:border-[#2563EB]/40 flex flex-col">



        <p className="text-xs font-semibold text-[#64748B] uppercase tracking-wider mb-2 ">Win Rate</p>
        <p className="text-3xl font-bold text-[#171717] tracking-tight mb-1">{stats.winRate}%</p>
        <p className="text-xs text-[#64748B]">
      ...
      {/* Profit factor */}
        ...
        <p className="text-xs font-semibold text-[#64748B] uppercase tracking-wider mb-2">Profit Factor</p>
        <p className="text-3xl font-bold text-[#171717] tracking-tight mb-1">
          {Number.isFinite(stats.profitFactor)
            ? stats.profitFactor.toFixed(2)
            : "∞"}
            </p>
        <p className="text-xs text-[#64748B]">Avg W/L ratio</p>
      </div>
    </div>
  );
}
      ...
      <div className="bg-[#F8FAFC] rounded-xl p-1 flex gap-1">
        <button
          ...
          className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${
            viewMode === 'cards'
              ? 'bg-[#5b8af0] text-white border border-gray'
              : 'text-[#64748B]'
          }`}
        >
...
//-----------------------------------------//
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-3 gap-6 justify-items-center">
      {trades.map(trade => (
      <TradeCard
      key={trade.id}
      trade={trade}
...
function TradeCard({ trade, onClick, displayMode, activeAccount, balanceBeforeMap }) {
  ...
  return (
    ...
    <div
  onClick={onClick}
  className="bg-white border border-[#E2E8F0] rounded-2xl overflow-hidden transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 hover:border-[#2563EB]/40">

              {/* ✅ IMPORTANT: emoji must NOT be inside overflow-hidden box */}
              <div className="relative ">
              {/* image wrapper keeps image clipped */}
              <div className="relative  bg-gradient-to-br from-[#647488]/15 to-[#DCFCE7] w-full h-60  overflow-hidden rounded-t-2xl ">
...
<div className="absolute inset-0  transition duration-300 group-hover:[#a0c4ff]" />

{/* gentle depth gradient (very light) */}
<div className="absolute inset-0 bg-gradient-to-t from-black/8 via-transparent to-transparent transition duration-300 group-hover:[#a0c4ff]" />
...
<div className="" />
        ...
        <div className="absolute left-1/2 -bottom-7 -translate-x-1/2 z-20">
          <div className="w-16 h-16 rounded-full bg-white border border-[#E2E8F0] shadow-ls flex items-center justify-center border border-[#E2E8F0] shadow-md flex items-center justify-center text-3xl border border-[#E2E8F0]">
            <Twemoji
      ...
      <div className="px-6 pt-12 pb-6 flex-1 flex flex-col">
        <div className="text-center">
          ...
          <h3 className="text-2xl font-bold text-[#171717] mb-4 tracking-tight">
            {trade.ticker}
          </h3>
          ...
          <div className="mt-3 flex justify-center">
            <span
              className={`inline-flex items-center  justify-center px-6 py-3 bg-[#DCFCE7] rounded-xl mb-4 ${pillClass}`}
        ...
        <div className="mt-6 pt-6 border-t border-[#E2E8F0]">
          <div className="grid grid-cols-3 gap-6 text-center">
            <div>
             <div className="text-xs text-[#64748B] mb-1 uppercase tracking-wider">SESSION</div>
            ...
            <div>
              <div className="text-xs text-[#64748B] mb-1 uppercase tracking-wider">DATE</div>
            ...
            <div>
              <div className="text-xs text-[#64748B] mb-1 uppercase tracking-wider">DIRECTION</div>
        ...
        <table className="w-full text-left table-fixed">
          <thead className="bg-[#FAFAFA] border-b border-[#E2E8F0]">
            <tr>
              ...
              <th className="px-4 py-3 text-xs font-semibold text-[#64748B] text-right">
                {displayMode === 'pnl' ? 'P&L' : 'R'}
              </th>
            </tr>
          </thead>
          ...
          return (
            <button
              ...
              className={`fixed bottom-8 right-8 w-14 h-14 rounded-full shadow-lg flex items-center justify-center transition-all ${
                disabled
                  ?  'bg-gray-300 text-[#64748B] cursor-not-allowed'
                  :  'bg-[#2563EB] text-white hover:bg-[#2563EB] hover:shadow-xl'
              }`}
            >
      ...
      {trade.screenshots.length > 1 && (
        <>
          <button
            ...
            className="absolute left-4 top-1/2 -translate-y-1/2 bg-[#2563EB] hover:bg-[#2563EB] text-white rounded-full w-12 h-12 flex items-center justify-center text-2xl shadow-sm"
          ...
          >
            <path strokeLinecap="round" strokeLinejoin="round" d="M15 19l-7-7 7-7" />
                      ...
                      className="absolute right-4 top-1/2 -translate-y-1/2 bg-[#2563EB] hover:bg-[#2563EB] text-white rounded-full w-12 h-12 flex items-center justify-center text-2xl shadow-sm"
              ...
              bg-[#F8FAFC] rounded-xl overflow-hidden border border-[#E2E8F0] relative">
                <img
                  src={trade.screenshots[imageIndex]}
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <p className="text-xs text-[#64748B] mb-0.5">Session</p>
              <p className="text-base font-medium">{trade.session || '-'}</p>
            </div>

            <div>
              <p className="text-xs text-[#64748B] mb-0.5">Direction</p>
              <span
            ...
            <div>
              <p className="text-xs text-[#64748B] mb-0.5">Time</p>
              <p className="text-base font-medium">
          ...
          {(() => {
            ...
            return (
              <div className="bg-[#FAFAFA] rounded-2xl p-4 border border-[#E2E8F0]">
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  <div className="min-w-0">
                    <p className="text-xs text-[#64748B] mb-0.5">P&L</p>
                    <p className={`text-xl font-bold ${pnlDisplay >= 0 ? 'text-[#2563EB]' : 'text-purple-600'}`}>
                      {pnlDisplay > 0 ? '+' : ''}${pnlDisplay}
                    </p>
                  </div>

                  <div className="min-w-0">
                    <p className="text-xs text-[#64748B] mb-0.5">R</p>
                   <p className={`text-xl font-bold ${rDisplay >= 0 ? 'text-[#2563EB]' : 'text-purple-600'}`}>
                      {formatRText(rDisplay)}
                    </p>
                  ...
                  <div className="min-w-0">
                    <p className="text-xs text-[#64748B] mb-0.5">PnL %</p>
                  ...
                  <div className="col-span-2 sm:col-span-4">
                    <div className="bg-white border border-[#E2E8F0] rounded-xl px-4 py-3 flex items-center justify-between">
                      <div>
                        <p className="text-sm font-semibold text-[#171717]">Breakeven</p>
                        <p className="text-xs text-[#64748B]">Mark this trade as BE</p>
                      </div>
          ...
          <div className="bg-white rounded-2xl p-4 border border-[#E2E8F0]">
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              <div>
                <p className="text-xs text-[#64748B] mb-0.5">Quantity</p>
                <p className="text-lg font-semibold text-[#171717]">{trade.quantity ?? '-'}</p>
              </div>
              <div>
                <p className="text-xs text-[#64748B] mb-0.5">Entry</p>
                <p className="text-lg font-semibold text-[#171717]">{trade.entryPrice ?? '-'}</p>
              </div>
              <div>
                <p className="text-xs text-[#64748B] mb-0.5">Exit</p>
                <p className="text-lg font-semibold text-[#171717]">{trade.exitPrice ?? '-'}</p>
              </div>
            </div>
          </div>
          ...
          {trade.notes && (
            <div>
              <p className="text-sm text-[#64748B] mb-2">Notes</p>
              <p className="text-[#64748B] leading-relaxed bg-[#FAFAFA] rounded-xl p-4">{trade.notes}</p>
            </div>
          )}
          ...
          <div className="flex gap-3 pt-4 border-t border-[#E2E8F0]">
            ...
            <button
              ...
              className="flex-1 bg-[#FEF2F2] text-[#EF4444] py-3 rounded-xl font-medium hover:bg-red-100 transition-colors"
            >
              Delete
            </button>
          </div>
...
function DeleteConfirmModal({
  ...
  onClick={onConfirm}
  disabled={!!deleting}
  className={`flex-1 bg-gray-300 text-[#64748B] py-3 rounded-xl font-medium hover:bg-gray-200 transition-colors ${
    deleting ? "bg-gray-300 text-[#64748B] cursor-not-allowed" : "bg-[#FEF2F2]0 text-white hover:bg-red-600"
  }`}
>
